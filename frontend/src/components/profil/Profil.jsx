      ...
      <div className="card mb-4">
        <div className="card-body text-center">
          <img
            ...
            style={{ width: 150 }}
          />
          {user.isLoggedIn ? <>  <h5 className="my-3">{user.name}</h5> </> :""}
          <p className="text-muted mb-4">Adresse : { user.adress }</p>
      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="row">
            ...
            {user.isLoggedIn ? <>  <p className="text-muted mb-0">{user.name}</p> </> :""}
            </div>
          </div>
          <hr />
          <div className="row">
